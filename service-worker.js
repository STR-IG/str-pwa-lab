const CACHE_NAME = 'str-ig-cache-v36';
...
async function withLabPatches(response, request) {
  ...
  const scripts = [
    '<script src="timesheet-lab-patch.js?v=36"></script>',
    '<script src="payroll-lab-patch.js?v=36"></script>',
    '<script src="timesheet-crop-guard-lab.js?v=36"></script>'
  ].join('');
